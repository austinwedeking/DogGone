...
{
    // use coroutines to trigger AI events and prevent multiple events from running at once
    ...
    private void Start()
    {
        //playerTransform = FindObjectOfType<PlayerMovement>().gameObject.GetComponent<Transform>();
        collisionLayer = 0;
        manageState();
    }
